function  normal= findNormal( x,a,b,CA,CB,dy1,dy2 )
...
if a==b
    normal=CA; %otan 3ekiname h teleiwnoume se korufh tou trigwnou kai CA=CB
else
    normal=CA+((dy2*(dy1*x-a))/(dy1*b-dy2*a))*(CB-CA); 
end
