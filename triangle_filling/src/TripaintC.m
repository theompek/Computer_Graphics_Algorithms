...
color=[];
for y=ymin:a-1
CA=(sqrt((EnergAkmes(1,1)-EnergShmeia(1)/dy1)^2+(EnergAkmes(1,2)-y)^2)*XrwmataShm(2,1:3) + ...
   sqrt((EnergAkmes(2,1)-EnergShmeia(1)/dy1)^2+(EnergAkmes(2,2)-y)^2)*XrwmataShm(1,1:3))/distance1;

CB=(sqrt((EnergAkmes(1,3)-EnergShmeia(2)/dy2)^2+(EnergAkmes(1,4)-y)^2)*XrwmataShm(2,4:6) + ...
   sqrt((EnergAkmes(2,3)-EnergShmeia(2)/dy2)^2+(EnergAkmes(2,4)-y)^2)*XrwmataShm(1,4:6))/distance2;
...
for x=xmin:xmax 
 ...
 color=findColor2(x,EnergShmeia(1),EnergShmeia(2),CA,CB,dy1,dy2);
